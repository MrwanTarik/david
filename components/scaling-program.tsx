...
import CloudLeftImage from "@/public/assets/c3.png";
  ...
  return (
    <div className="relative">
      ...
      <div className="py-8 md:py-12 lg:py-16 px-4 md:px-8 lg:px-20 max-w-[1440px] mx-auto">
        <p data-aos="fade-up" className="text-center text-[#6CB6FF] mb-8">
          You invoice, we pay
        </p>
        ...
        <p
          data-aos="fade-up"
          data-aos-delay="100"
          className="text-center text-[#2e3b7d] max-w-[800px] mx-auto mb-[120px] leading-relaxed"
        >
          ...
          automatically generates an invoice and sends funds within 48 hours.
          Our payroll system handles all fees and taxes in your country so that
          you can focus on trading.
        </p>

        <h2
          data-aos="fade-up"
          data-aos-delay="200"
          className="text-center text-[40px] md:text-[48px] font-violet-sans text-[#2e3b7d] mb-6"
        >
          Scaling program
        </h2>
        ...
        <p className="text-center text-[#2e3b7d] max-w-[800px] mx-auto mb-16 leading-relaxed">
          Each time you hit the profit target, you qualify for additional
          funding. After 90 days of trading, you could reach Series C and manage
          up to 250K funding.
        </p>

        <div className="space-y-6">
          {fundingSeries.map((series, index) => (
            <div
              key={series.id}
              data-aos="fade-up"
