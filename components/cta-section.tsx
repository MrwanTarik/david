...
export default function CTASection() {
  return (
    <div className="relative">
      ...
      >
        <Image
          className="w-full h-[637px] object-contain"
          src={ctaBg}
          alt="Blue crystal shapes with clouds"
        />
      </div>
      <div className="py-8 md:py-12 lg:py-16 px-4 md:pl-8 lg:pl-20 max-w-[1440px] mx-auto md:mt-15 md:mb-30">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <div
            ...
            className="md:w-[45%]"
          >
            <h2 className="text-[26px] md:text-[32px] lg:text-[40px] text-[#2e3b7d] mb-6 font-violet-sans font-normal text-center md:text-left">
              Are you ready to become Only Trades Funded Trader?
            </h2>
            ...
            >
              By progressively innovating our programs, technology and culture
              we help undercapitalized and aspiring traders turn their
              strategies into revenue
            </p>
