...
import CloudRightImage from "@/public/assets/c4.png";

export default function HeroSection() {
  return (
    <div className="relative">
      <div className="absolute right-0 top-[-10%] -z-10 xl:z-10">
        <Image className="object-contain" src={CloudRightImage} alt="" />
      </div>
      <div className="relative mt-0 md:mt-[118px] py-12 px-4 md:py-20 md:px-8 lg:px-20 max-w-[1440px] mx-auto">
        ...
        >
          ...
          <div className="text-center max-w-[800px] mt-[200px] mx-auto">
            ...
            >
              Lorem ipsum dolor sit amet consectetur. Urna accumsan sagittis
              vivamus interdum.
            </p>
