...
const CookiesPolicy = () => {
  ...
  return (
    <div className="py-8 md:py-12 px-4 md:px-8 lg:px-20 max-w-[1440px] mx-auto">
      <h2  data-aos="fade-up"  className="text-center text-[40px] md:text-[48px] lg:text-[56px] font-violet-sans mb-8 md:mb-12">
        <span className="text-[#6CB6FF]">Cookies </span>
        <span className="text-[#2e3b7d]">Policy</span>
      </h2>
