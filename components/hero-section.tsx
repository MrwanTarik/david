...
export default function HeroSection() {
  return (
    <div className=" pt-20 px-4 md:px-8 lg:px-20 max-w-[1440px] mx-auto mb-30">
      <div className="max-w-[1440px] mx-auto z-10 relative">
        ...
        <div className="grid grid-cols-12">
          ...
          Grow Your <br /> Online Trading <br /> With{" "}
          <span className="text-[#14AAF5] ">Only Trades</span>
        </h1>
        <p className="text-[16px] md:text-[18px] text-[black] mb-8 max-w-[543px]  font-inter">
        ...
        <div className="flex flex-row justify-center md:justify-start gap-4">
          ...
          <div className="relative md:block hidden col-span-12 md:col-span-6">
            <Image src={heroBg} alt="Hero background" className="object-cover absolute top-[50%] right-[0] translate-x-[5%] translate-y-[-50%] " />
          </div>
        </div>
      </div>
      <div>
